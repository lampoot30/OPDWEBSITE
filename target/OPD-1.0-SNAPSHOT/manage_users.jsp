                        ...
                        <tbody>
                            <c:forEach var="user" items="${userList}">
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <button type="button" class="btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#archiveUserModal" data-user-id="${user.userId}" data-username="${user.username}">
