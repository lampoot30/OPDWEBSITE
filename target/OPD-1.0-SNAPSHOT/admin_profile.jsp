...
<div class="main-content">
    ...
    <div class="profile-header d-flex align-items-center">
        ...
        <div class="ms-auto">
            <a href="<c:url value='/edit-admin-profile'/>" class="btn btn-outline-primary"><i class="fas fa-edit me-2"></i>Edit Profile</a>
        </div>
    </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3"><label class="form-label text-muted small">Age</label><p class="fw-bold">${adminProfile.age} years old</p></div>
